...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_list_dir', type=str, default='./data_list/framesplit_list.txt')
    parser.add_argument('--save_folder', type=str, default='./results_val-test/framesplit/')
